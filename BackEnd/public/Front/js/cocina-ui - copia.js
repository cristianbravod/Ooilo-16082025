            ...
            <div class="order-header">
                ...
                ${showActions ? `
                    <div class="order-actions">
                        <button class="btn btn-sm ${displayStatus === 'pendiente' ? 'active' : ''}" onclick="handleOrderStatusChange(${orden.id}, 'pendiente')">⏳ Pendiente</button>
                        <button class="btn btn-sm ${displayStatus === 'preparando' ? 'active' : ''}" onclick="handleOrderStatusChange(${orden.id}, 'preparando')">🔥 Preparando</button>
                        <button class="btn btn-sm ${displayStatus === 'lista' ? 'active' : ''}" onclick="handleOrderStatusChange(${orden.id}, 'lista')">✅ Listo</button>
                        <button class="btn btn-sm ${displayStatus === 'entregada' ? 'active' : ''}" onclick="handleOrderStatusChange(${orden.id}, 'entregada')">📦 Entregada</button>
                    </div>
                ` : ''}
            </div>
        ...
        <div class="order-item ${highlightClass}" data-item-id="${item.id}">
            ...
            ${showActions ? `
                <div class="item-actions">
                    <button class="btn btn-sm ${item.estado === 'pendiente' ? 'active' : ''}" onclick="handleItemStatusChange(${orden.id}, ${item.id}, 'pendiente')">⏳</button>
                    <button class="btn btn-sm ${item.estado === 'preparando' ? 'active' : ''}" onclick="handleItemStatusChange(${orden.id}, ${item.id}, 'preparando')">🔥</button>
                    <button class="btn btn-sm ${item.estado === 'lista' ? 'active' : ''}" onclick="handleItemStatusChange(${orden.id}, ${item.id}, 'lista')">✅</button>
                </div>
            ` : ''}
        </div>
    `;
